...
var EchartsReactCore = function (_Component) {
  ...
  function EchartsReactCore(props) {
    ...
    _this.getEchartsInstance = function () {
      return _this.echartsInstance.getInstanceByDom(_this.echartsElement) || _this.echartsInstance.init(_this.echartsElement, _this.props.theme, { renderer: _this.props.renderer });
    };
