...
var EchartsReactCore = function (_Component) {
  ...
  function EchartsReactCore(props) {
    ...
    _this.rerender = function () {
      ...
      if (_this.echartsElement) {
        var prevSize = {
          width: _this.echartsElement.clientWidth,
          height: _this.echartsElement.clientHeight
        };
        (0, _sizeSensor.bind)(_this.echartsElement, function (el) {
          var size = {
            width: el.clientWidth,
            height: el.clientHeight
          };
          if (!(0, _fastDeepEqual2['default'])(prevSize, size)) {
            try {
              echartObj.resize();
              prevSize = size;
            } catch (e) {
