...
var EchartsReactCore = function (_Component) {
  ...
  function EchartsReactCore(props) {
    ...
    _this.rerender = function () {
      ...
      // on resize
      if (_this.echartsElement) {
        (0, _elementResizeEvent2['default'])(_this.echartsElement, (0, _utils.debounce)(echartObj.resize, 100));
      }
    };
  ...
  _createClass(EchartsReactCore, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (prevProps.theme !== this.props.theme || !(0, _fastDeepEqual2['default'])(prevProps.opts, this.props.opts) || !(0, _fastDeepEqual2['default'])(Object.keys(prevProps.onEvents || {}).sort(), Object.keys(this.props.onEvents || {}).sort())) {
        this.dispose();
