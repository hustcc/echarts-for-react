...
var EchartsReactCore = function (_Component) {
  ...
  _createClass(EchartsReactCore, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (prevProps.theme !== this.props.theme || !(0, _utils.isEqual)(prevProps.opts, this.props.opts) || !(0, _utils.isEqual)(Object.keys(prevProps.onEvents || {}).sort(), Object.keys(this.props.onEvents || {}).sort())) {
        this.dispose();
      ...
      var pickKeys = ['option', 'notMerge', 'lazyUpdate'];
      if ((0, _utils.isEqual)((0, _utils.pick)(this.props, pickKeys), (0, _utils.pick)(prevProps, pickKeys))) {
        return;
      }

      var echartObj = this.renderEchartDom();
      // 样式修改的时候，可能会导致大小变化，所以触发一下 resize
      if (!(0, _utils.isEqual)(prevProps.style, this.props.style) || !(0, _utils.isEqual)(prevProps.className, this.props.className)) {
        try {
          echartObj.resize();
        } catch (_) {}
      }
