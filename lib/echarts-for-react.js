...
var ReactEcharts = _react2['default'].createClass({
    ...
    renderEchartDom: function renderEchartDom() {
        ...
        // set loading mask
        if (this.props.showLoading && this.props.loadingOption) echartObj.showLoading(this.props.loadingOption);else if (this.props.showLoading) echartObj.showLoading();else echartObj.hideLoading();
